...
- Only the code between PHP tags (opening; <?php & closing; ?>) is processed/interpreted and rest is ignored or output as it is. This makes easy for users to embed PHP and HTML in a single file.
